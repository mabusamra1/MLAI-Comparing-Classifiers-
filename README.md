...
[Link to notebook:]  AIML-Portfolio-Comparing-Classifiers/prompt_III.ipynb at main · mabusamra1/MLAI-Comparing-Classifiers-](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/prompt_III.ipynb) 
...
![original.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/original.png)
...
In Figure 1, the disbribution of the  campaign population across various feature categories is presented, providing a hit as to which feature and associated categories may influence the 'deposit subscription' outcome as 'yes' or 'no'. Figure 2 provides the numerical feature distribution and a view of the outliers per feature. 
 ...
 ![box_hist_age_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_age_dist.png) 

 ![box_hist_campaign_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_campaign_dist.png) 

 ![box_hist_cons.conf.idx_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_cons.conf.idx_dist.png) 

 ![box_hist_cons.price.idx_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_cons.price.idx_dist.png) 

 ![box_hist_duration_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_duration_dist.png) 

 ![box_hist_emp.var.rate_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_emp.var.rate_dist.png) 

 ![box_hist_euribor3m_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_euribor3m_dist.png) 

 ![box_hist_nr.employed_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_nr.employed_dist.png) 

 ![box_hist_pdays_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_pdays_dist.png) 

 ![box_hist_previous_dist.png](https://github.com/mabusamra1/MLAI-Comparing-Classifiers-/blob/main/Images/box_hist_previous_dist.png) 
